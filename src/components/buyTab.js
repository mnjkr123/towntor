                    ...
                    <div className="col-md-4">
                        <ul className="nav nav-pills nav-justified flex-column bg-white rounded-3 shadow p-3 mb-0 sticky-bar" id="pills-tab" role="tablist">
                            <li className="nav-item">
                                <Link to="#" className={`${activeIndex === 0 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(0)}>
                            ...
                            <li className="nav-item mt-2">
                                <Link to="#" className={`${activeIndex === 1 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(1)}>
                                    <div className="text-center pt-1 pb-1">
                            ...
                            <li className="nav-item mt-2">
                                <Link to="#" className={`${activeIndex === 2 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(2)}>
                                    <div className="text-center pt-1 pb-1">
                            ...
                            <li className="nav-item mt-2">
                                <Link to="#" className={`${activeIndex === 3 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(3)}>
                                    <div className="text-center pt-1 pb-1">
                            ...
                            <li className="nav-item mt-2">
                                <Link to="#" className={`${activeIndex === 4 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(4)}>
                                    <div className="text-center pt-1 pb-1">
                            ...
                            <li className="nav-item mt-2">
                                <Link to="#" className={`${activeIndex === 5 ? "active" : ""} nav-link rounded-3`} onClick={() =>setActiveIndex(5)}>
                                    <div className="text-center pt-1 pb-1">

                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    ...
                                    <ul className="list-unstyled footer-list mt-4">
                                        ...
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Services</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Team</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Pricing</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Project</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Careers</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Blog</Link></li>
                                        <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right align-middle me-1"></i> Login</Link></li>
                                    </ul>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    ...
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="">
                                            ...
                                            <Link to="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" data-type="iframe" className="text-primary lightbox">View on Google map</Link>
                                        </div>
                                    </div>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="text-center">
                                <p className="mb-0">© {new Date().getFullYear()} Towntor. Design & Develop with <i className="mdi mdi-heart text-danger"></i> by <Link to="https://shreethemes.in/" target="_blank" className="text-reset">Shreethemes</Link>.</p>
                            </div>
                        </div>
                    </div>
                </div>
